...
public class DataFileTableModelPlaylist extends AbstractTableModel {
	...
	// private String nomFichier = "C:" + File.separator + "MoxMusic" +File.separator+ "Content" + File.separator + "chanson.txt";
	 ...
	 public DataFileTableModelPlaylist(String nomFichier) {
	     playlists =(ArrayList<Playlist>)(Object)recupM.recuperationMusique(nomFichier);
	     initVectors();
	    }
	 
	 public DataFileTableModelPlaylist() {
		super();
		initVectors();
	}
